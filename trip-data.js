...
//
// ★ SEED_VERSION: 이 파일의 일정을 수정했으면 반드시 아래 버전 문자열도 올려라 (날짜 권장).
//   앱은 로그인 시 클라우드(Firebase)/로컬 저장본의 seedVersion 이 이 값과 다르면
//   저장본을 버리고 이 파일의 일정으로 교체한 뒤 클라우드에 다시 업로드한다.
//   (앱 안에서 편집한 상태/메모도 함께 초기화되므로, 확정 일정을 여기에 반영한 뒤 올릴 것)
window.TRIP_SEED_VERSION="2026-09-09";
...
{time:"17:35",title:"✈️ 라이언에어 바르셀로나 → 포르투",placeName:"Barcelona El Prat Airport",desc:"약 1시간 · 20kg 수하물 포함",type:"flight",status:"confirmed",memo:"✅ 예약 완료 (2인 332,132원 · 192.86유로) · 예약번호는 라이언에어 앱/메일 확인 후 기록",url:"https://www.ryanair.com/kr/ko/trip/manage",cost:332132,coords:[41.2971,2.0785]},
...
{time:"21:10",title:"✈️ 라이언에어 포르투 → 팔마",placeName:"Porto Airport",desc:"1시간 49분 · 20kg 수하물 포함",type:"flight",status:"confirmed",memo:"✅ 예약 완료 · 예약번호는 라이언에어 앱/메일 확인 후 기록",url:"https://www.ryanair.com/kr/ko/trip/manage",cost:340000,coords:[41.2370,-8.6700]},
...
flights:[
 ...
 {no:2,leg:"바르셀로나 → 포르투",date:"9/16 (수)",airline:"라이언에어",flight:"—",sched:"17:35 ~ 18:35",dur:"약 1시간",ref:"—",bag:"20kg (포함)",term:"—",status:"confirmed",
  price:"2인 332,132원 (192.86유로)",note:"✅ 예약 완료 — 예약번호는 라이언에어 앱/메일에서 확인 후 여기에 기록",url:"https://www.ryanair.com/kr/ko/trip/manage"},
 {no:3,leg:"포르투 → 팔마(마요르카)",date:"9/20 (일)",airline:"라이언에어",flight:"—",sched:"21:10 ~ 23:59",dur:"1시간 49분",ref:"—",bag:"20kg (포함)",term:"—",status:"confirmed",
  price:"2인 약 34만원",note:"✅ 예약 완료 — 예약번호는 라이언에어 앱/메일에서 확인 후 여기에 기록",url:"https://www.ryanair.com/kr/ko/trip/manage"},
